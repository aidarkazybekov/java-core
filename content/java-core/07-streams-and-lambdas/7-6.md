...
## Tip
Never call Optional.get() without checking. Use orElseThrow() (Java 10+) instead -- it communicates intent better and is the modern replacement for the poorly-named get().
...
### springFeature
Spring Data repository return types
