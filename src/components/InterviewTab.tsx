...
export default function InterviewTab({ content, progress, onRate }: InterviewTabProps) {
  ...
  const difficultyLabel = (d: "junior" | "mid" | "senior") => {
              ...
              <AnimatePresence>
                ...
                >
                  <div className="p-4 bg-[#0f1a0f]">
                    ...
                    <span className="text-[13px] text-[#86efac] leading-[1.7] whitespace-pre-line">
                      {aText}
                    </span>
                  </div>
                  ...
                  {!isRated ? (
                    <div className="px-4 py-3 border-t border-border bg-bg-elevated flex items-center gap-2">
                      <span className="text-[10px] text-text-muted mr-2">{t("rate", locale)}</span>
