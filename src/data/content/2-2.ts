...
export const topic: TopicContent = {
  ...
  tip: "When a local variable captures a value in a lambda and you need to mutate it, use an AtomicInteger or a single-element array as the captured reference. The reference is effectively final, but its contents are mutable.",
  springConnection: {
